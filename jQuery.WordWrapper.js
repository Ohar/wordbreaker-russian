...
(function ($) {
    $.fn.wordwrapper = function () {
        ...
        var vowels = ['а', 'е', 'ё', 'и', 'о', 'у', 'ы', 'э', 'ю', 'я'],
            ...
            prefixes = ['без', 'безо', 'бес', 'в', 'вз', 'взаимо', 'взо', 'вне',
                'внутри', 'во', 'воз', 'возо', 'вос', 'вс', 'все', 'вы', 'до',
                'еже', 'за', 'из', 'изо', 'ис', 'испод', 'кое', 'кой', 'ку',
                'меж', 'междо', 'между', 'мимо', 'на', 'над', 'наи', 'не', 'небез',
                'небезо', 'небес', 'недо', 'ни', 'низ', 'низо', 'нис', 'о', 'об',
                'обез', 'обезо', 'обес', 'обо', 'обще', 'около', 'от', 'ото', 'пере',
                'по', 'под', 'пода', 'подо', 'поза', 'после', 'пра', 'пре', 'пред',
                'предо', 'при', 'про', 'против', 'противо', 'раз', 'разо', 'рас',
                'роз', 'рос', 'с', 'сверх', 'со', 'среди', 'су', 'сыз', 'тре', 'у',
                'через', 'черес', 'чрез'],
            SOFT_HYPHEN = "\u00AD";
